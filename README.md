...
It includes:
1.Extraction of title from name to include effects of class system as Title
...
NaN values filled using median for numeric cols and mode for categorical cols
Encoding of categorical cols using .replace()
